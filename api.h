...
inline bool vnrRequireDecoding(int m)
{
  ...
  case VNR_RAYMARCHING_NO_SHADING_DECODING:
    return true;
  case VNR_RAYMARCHING_NO_SHADING_SAMPLE_STREAMING:
  case VNR_RAYMARCHING_NO_SHADING_IN_SHADER:
    return false;

  case VNR_RAYMARCHING_GRADIENT_SHADING_DECODING:
    return true;
  case VNR_RAYMARCHING_GRADIENT_SHADING_SAMPLE_STREAMING:
  case VNR_RAYMARCHING_GRADIENT_SHADING_IN_SHADER:
    return false;

  case VNR_RAYMARCHING_SINGLE_SHADE_HEURISTIC_DECODING:
    return true;
  case VNR_RAYMARCHING_SINGLE_SHADE_HEURISTIC_SAMPLE_STREAMING:
  case VNR_RAYMARCHING_SINGLE_SHADE_HEURISTIC_IN_SHADER:
    return false;

  case VNR_PATHTRACING_DECODING:
    return true;
  case VNR_PATHTRACING_SAMPLE_STREAMING:
  case VNR_PATHTRACING_IN_SHADER:
    return false;
